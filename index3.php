...
<style>
#btn{width:100%;}#btn1{width:100%;}#btn3{width:100%;}#btn1{width:100%;}#btn4{width:100%;}#btn11{width:100%;}
...
<div class="container">
 ...
 <center> <table width="200" border="0" id="table1" hidden="true">
  <tr>
...
<center><p  style="color:#960"><h4><?php echo "Cliente:  $cliente" ?></h4></p></center>
  ...
  <p><center><table width="335" border="1" id="tabla2">
  <tr>
    <td colspan="5"><div align="center" style="color:#960">Resumen de Compra</div></td>
  </tr>
  <tr>
    <td>Prod:</td>
    <td width="59">Foto</td>
    <td width="47">Cant</td>
    <td width="74">Precio</td>
    <td width="42">Total</td>
  </tr>
  
  <?php $sw2=0;
  include 'conectar/link.php';
$conn=mysqli_query($conn,"SELECT * FROM compra WHERE ci='$ci' and numaux='$num'")
or die ("Error a extraer datos");
 while ($sacar=mysqli_fetch_array($conn))
{
	$sw2++;
	$prod= $sacar['producto'];
	$des=$sacar['descripcion'];
	$foto2=$sacar['foto'];
	$cant=$sacar['cantidad'];
	$precio=$sacar['precio'];
	$total=$sacar['total'];
...
?>
<tr>
    <td width="79"><?php echo $prod ?>;</td>
 <td> <img img class="zoom"   src='<?php echo 'file/'.$foto2; ?>' width='59' height='57' /></td>
    <td><?php echo $cant ?></td>
     <td><?php echo $precio ?></td>
     <td><?php echo $total?></td>
  </tr><?php } ?>
  <tr>
    <td colspan="5"><?php echo "Total = $acum"?></td>
  </tr>
  <tr>
    <td colspan="5"><button id="btn11" type="button" onClick="factu()" class="btn btn-success btn-sm">Factura</button></td>
    </tr>
</table></center></p>
 <center> <table width="168" border="0" id="tabla3">
  ...
  <p align="center" style="color:#960" onClick="aa()" id="ins" hidden="true">Inscripción Cliente</p>
 ...
 <center> <table width="200" border="1">
    ...
    <tr>
      <td width="125" id="c1"><div align="center"><img src="img/correa.jpg" onClick="corre2()"  width="91" height="89" title="Click en imagen y verá Correa"></div></td>
...
document.getElementById('malo').innerHTML="No esta autorizado para ingresar a esa área";
document.getElementById('table1').style.display='none';
});
	}
	function ocu(){
...
window.location="back/producto.php?ci="+ci+"&tipo="+tipo;;
	...
	var ci=document.getElementById('cicli2').value;
	alert(ci)
	window.location='back/creafactura.php?ci='+ci;
}
	</script>
